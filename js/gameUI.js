...
export class GameUI {
    ...
    createButtons(scene, main)
    {
       ...
       this.buttons.push(sprite);
        ...
        context1.font = 'Bold 40px "Press Start 2P"';
        context1.fillStyle = 'black';
        context1.fillText('Reset', 20, 100);
        ...
        sprite2.position.set(-170, -300, 0);
        ...
        context2.font = 'Bold 150px "Press Start 2P"';
        ...
        sprite3.position.set(170, -300, 0);
        ...
        context3.font = 'Bold 150px "Press Start 2P"';
        context3.fillStyle = 'black';
        context3.fillText('+', 50, 150);
        ...
        sprite5.scale.set(300, 50, 1);
        sprite5.position.set(0, -300, 0);
        ...
        context5.font = 'Bold 70px "Press Start 2P"';
        context5.fillStyle = 'black';
        context5.fillText('Floors: 1', 0, 140, 300);
        ...
        this.levelsText.scale.set(100, 50, 1);
    ...
    lessFloorsButton()
    {
        ...
        console.log("amount of levels reduced by 1");
            this.updateText(this.levelsText, "Floors: " + newValue.toString());
        }
    }
    MoreFloorsButton()
    {
    ...
    updateText(sprite, newText)
    {
       ...
       const ctx = canvas.getContext('2d');
        ...
        ctx.fillText(newText, 0, 140, 300);
